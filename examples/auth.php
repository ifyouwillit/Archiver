...
$tmhOAuth = new tmhOAuth(array( 
  'consumer_key'    => 'ZnB9wfGNuvVrjNFQRBxYtQ',
  'consumer_secret' => 'c9QTSfHWmXoM0fHATyVG4lO6LO6s3PzxnxMtPfrOVKY',
));
...
// already got some credentials stored?
  ...
  if ($code == 200) {
   ...
   // echo "[".$resp->screen_name."]";
    $GLOBALS['authsn']=$resp->screen_name;
  } else {
...
?><?php if ($resp->screen_name<>'') { ?>
<img src="https://api.twitter.com/1/users/profile_image?screen_name=<?=$resp->screen_name?>&size=mini"> <a href="?wipe=1">Logout</a>
<?php  } else {?>
<div class="LoginButtonsBold"><a href="?authenticate=1" class="WikiLinks"><b>Login with Twitter</b></a></div> <div class="LoginButtons">Sign Up</div> <div class="LoginButtons"><a href="http://worldlifenetworks.com/contact-and-support/" target="_blank" class="WikiLinks">Support</a></div> <div class="LoginButtons"><a href="http://support.worldlifenetworks.com/solution/categories/45184/folders/73336" class="WikiLinks" target="_blank">FAQ</a></div> 

<?php  if ($authurl) { header('Location: '.$authurl); } }?>