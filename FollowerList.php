...
loadDatafromRanch ( array (
		"http://dataranch.net/archiver/followers.xml?q=" . $q,
...
<title>Users with <?=$q?> Followers | Archiver</title>

<!--Meta -->
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<meta Name="Keywords"
	content="<?=$q?> followers, archiver, social archive" />
<meta Name="Description"
	content="Archive of social media posts from users with <?=$q?> followers from Twitter, Identica, Statusnet, Brainbird, and other micro-blogging websites." />
<meta property="og:title" content="Users with <?=$q?> Followers" />
		...
		<div class="MiddlePane">
			<div class="SearchName">
				<div style="clear: both;">
					<h1 class="SearchTitle">USERS WITH <?=strtoupper($q)?> FOLLOWERS</h1><? include("Disqus.php") ?>
...
<?php DisplayCloud($GLOBALS['search']); ?>
<? include ('Scripts/HorizontalAd.php');?>
</div>
